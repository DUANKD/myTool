...
/**
 * SpringFestivalInviteUserVO 的比较器
 *
 * @author duankd
 * @ClassName MapValueComparator
 * @date 2021-01-22 10:40:16
 */
public class InviteUserVOMapValueComparator implements Comparator<Map.Entry<Long, SpringFestivalInviteUserVO>> {
    ...
    public int compare(Map.Entry<Long, SpringFestivalInviteUserVO> o1, Map.Entry<Long, SpringFestivalInviteUserVO> o2) {
        return o1.getValue().getInviteUserNum().compareTo(o2.getValue().getInviteUserNum());
    }
}
