...
public class JsonReadTest {
    ...
    public void test1() {
        ...
        String jsonStr1 = JSON.toJSONString("test", SerializerFeature.PrettyFormat);
        String parseStr = JSON.parseObject(jsonStr, String.class);
        String parseStr1 = JSONUtil.toJsonStr(str);

        TestModel upmsUser = new TestModel();
        upmsUser.setContext("冻结");
        String jsonStrU = JSON.toJSONString(upmsUser);
        TestModel upmsUser1 = JSON.parseObject(jsonStrU, TestModel.class);
        List<TestModel> list = new ArrayList<>();
        list.add(upmsUser);
        String jsonStrL = JSON.toJSONString(list);
        List<TestModel> list1 = JSON.parseArray(jsonStrL, TestModel.class);
        System.out.println(str);
    }
}
